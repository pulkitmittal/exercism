...
var author$project$Triangle$isLegal = F3(
	function (x, y, z) {
		return (_Utils_cmp(x + y, z) > 0) && ((_Utils_cmp(y + z, x) > 0) && (_Utils_cmp(z + x, y) > 0));
	});
var author$project$Triangle$triangleKind = F3(
	function (x, y, z) {
		return ((x > 0) && ((y > 0) && (z > 0))) ? (A3(author$project$Triangle$isLegal, x, y, z) ? ((_Utils_eq(x, y) && _Utils_eq(y, z)) ? elm$core$Result$Ok(author$project$Triangle$Equilateral) : ((_Utils_eq(x, y) || (_Utils_eq(y, z) || _Utils_eq(z, x))) ? elm$core$Result$Ok(author$project$Triangle$Isosceles) : elm$core$Result$Ok(author$project$Triangle$Scalene))) : elm$core$Result$Err('Violates inequality')) : elm$core$Result$Err('Invalid lengths');
	});
...
var author$project$Test$Generated$Main3656791566$main = A2(
	author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/pulkit/Playground/exercism/elm/triangle/tests/Tests.elm']),
		processes: 8,
		report: author$project$Test$Reporter$Reporter$ConsoleReport(author$project$Console$Text$UseColor),
		runs: elm$core$Maybe$Nothing,
		seed: 399619309222531
	},
...
_Platform_export({'Test':{'Generated':{'Main3656791566':{'init':author$project$Test$Generated$Main3656791566$main(elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-8325.sock";
