...
var author$project$SpaceAge$secondsOnEarth = 31557600;
var author$project$SpaceAge$ageOn = F2(
	function (planet, seconds) {
		...
		return seconds / (author$project$SpaceAge$secondsOnEarth * coefficient);
	});
		...
		[
			...
			function (_n0) {
				return A2(
					...
					elm$core$Basics$round(
						A2(author$project$SpaceAge$ageOn, author$project$SpaceAge$Earth, 1.0e9)));
			}),
			A2(
			elm_explorations$test$Test$test,
			...
			function (_n1) {
				return A2(
					...
					281,
					elm$core$Basics$round(
						A2(author$project$SpaceAge$ageOn, author$project$SpaceAge$Mercury, 2.134835688e9)));
			}),
			A2(
			elm_explorations$test$Test$test,
			'age in venus years',
			function (_n2) {
				return A2(
					...
					10,
					elm$core$Basics$round(
						A2(author$project$SpaceAge$ageOn, author$project$SpaceAge$Venus, 1.89839836e8)));
			}),
			A2(
			elm_explorations$test$Test$test,
			'age on mars',
			function (_n3) {
				return A2(
					...
					39,
					elm$core$Basics$round(
						A2(author$project$SpaceAge$ageOn, author$project$SpaceAge$Mars, 2.329871239e9)));
			}),
			A2(
			elm_explorations$test$Test$test,
			'age on jupiter',
			function (_n4) {
				return A2(
					...
					2,
					elm$core$Basics$round(
						A2(author$project$SpaceAge$ageOn, author$project$SpaceAge$Jupiter, 9.01876382e8)));
			}),
			A2(
			elm_explorations$test$Test$test,
			'age on saturn',
			function (_n5) {
				return A2(
					...
					3,
					elm$core$Basics$round(
						A2(author$project$SpaceAge$ageOn, author$project$SpaceAge$Saturn, 3.0e9)));
			}),
			A2(
			elm_explorations$test$Test$test,
			'age on uranus',
			function (_n6) {
				return A2(
					...
					1,
					elm$core$Basics$round(
						A2(author$project$SpaceAge$ageOn, author$project$SpaceAge$Uranus, 3.210123456e9)));
			}),
			A2(
			elm_explorations$test$Test$test,
			'age on neptune',
			function (_n7) {
				return A2(
					...
					2,
					elm$core$Basics$round(
						A2(author$project$SpaceAge$ageOn, author$project$SpaceAge$Neptune, 8.210123456e9)));
			})
		]));
...
var author$project$Test$Generated$Main4149717362$main = A2(
	author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/pulkit/Playground/exercism/elm/space-age/tests/Tests.elm']),
		processes: 8,
...
_Platform_export({'Test':{'Generated':{'Main4149717362':{'init':author$project$Test$Generated$Main4149717362$main(elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-8255.sock";
