...
var author$project$TwoFer$twoFer = function (name) {
	if (name.$ === 'Nothing') {
		...
		var withName = name.a;
		return 'One for ' + (withName + ', one for me.');
	}
};
...
var author$project$Test$Generated$Main2864126437$main = A2(
	author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/pulkit/Playground/exercism/elm/two-fer/tests/Tests.elm']),
		processes: 8,
...
_Platform_export({'Test':{'Generated':{'Main2864126437':{'init':author$project$Test$Generated$Main2864126437$main(elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-1460.sock";
