...
var author$project$Anagram$isAnagram = function (_n0) {
	var word1 = _n0.a;
	var word2 = _n0.b;
	var w2 = elm$core$String$toUpper(word2);
	var w1 = elm$core$String$toUpper(word1);
	return (!_Utils_eq(w1, w2)) && _Utils_eq(
		elm$core$List$sort(
			elm$core$String$toList(w1)),
		elm$core$List$sort(
			elm$core$String$toList(w2)));
};
var author$project$Anagram$detect = F2(
	function (word, candidates) {
		return A2(
			elm$core$List$filter,
			function (w) {
				return author$project$Anagram$isAnagram(
					_Utils_Tuple2(word, w));
			},
			candidates);
	});
...
var author$project$Test$Generated$Main1648936730$main = A2(
	author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/pulkit/Playground/exercism/elm/anagram/tests/Tests.elm']),
		processes: 8,
		report: author$project$Test$Reporter$Reporter$ConsoleReport(author$project$Console$Text$UseColor),
		runs: elm$core$Maybe$Nothing,
		seed: 262124123093381
	},
...
_Platform_export({'Test':{'Generated':{'Main1648936730':{'init':author$project$Test$Generated$Main1648936730$main(elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-12137.sock";
