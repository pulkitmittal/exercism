...
var author$project$Leap$isLeapYear = function (year) {
	return (!A2(elm$core$Basics$modBy, 400, year)) || ((!A2(elm$core$Basics$modBy, 4, year)) && (A2(elm$core$Basics$modBy, 100, year) > 0));
};
...
var author$project$Test$Generated$Main2210335037$main = A2(
	author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/pulkit/Playground/exercism/elm/leap/tests/Tests.elm']),
		processes: 8,
		report: author$project$Test$Reporter$Reporter$ConsoleReport(author$project$Console$Text$UseColor),
		runs: elm$core$Maybe$Nothing,
		seed: 131979531531882
	},
...
_Platform_export({'Test':{'Generated':{'Main2210335037':{'init':author$project$Test$Generated$Main2210335037$main(elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-6401.sock";
