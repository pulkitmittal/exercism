...
var author$project$RNATranscription$matchLength = F2(
	function (str1, str2) {
		return _Utils_eq(
			elm$core$String$length(str1),
			elm$core$String$length(str2));
	});
var author$project$RNATranscription$toRNANucleotide = function (dna) {
	switch (dna.valueOf()) {
		case 'G':
			return _Utils_chr('C');
		case 'C':
...
var author$project$RNATranscription$toRNA = function (dna) {
	var rna = A2(elm$core$String$map, author$project$RNATranscription$toRNANucleotide, dna);
	return ((!A2(elm$core$String$contains, '.', rna)) && A2(author$project$RNATranscription$matchLength, rna, dna)) ? elm$core$Result$Ok(rna) : elm$core$Result$Err(
		_Utils_chr('X'));
};
		...
		[
			...
			function (_n5) {
				return A2(
					...
					elm$core$Result$Err(
						_Utils_chr('X')),
					author$project$RNATranscription$toRNA('ABC'));
			})
		]));
...
var author$project$Test$Generated$Main3851536739$main = A2(
	author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/pulkit/Playground/exercism/elm/rna-transcription/tests/Tests.elm']),
		processes: 8,
...
_Platform_export({'Test':{'Generated':{'Main3851536739':{'init':author$project$Test$Generated$Main3851536739$main(elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-7405.sock";
