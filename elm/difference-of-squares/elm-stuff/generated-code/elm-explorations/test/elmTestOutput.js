...
var author$project$DifferenceOfSquares$sumOfSquares = function (n) {
	return (n > 0) ? (A2(elm$core$Basics$pow, n, 2) + author$project$DifferenceOfSquares$sumOfSquares(n - 1)) : 0;
};
var author$project$DifferenceOfSquares$difference = function (n) {
	return author$project$DifferenceOfSquares$squareOfSum(n) - author$project$DifferenceOfSquares$sumOfSquares(n);
};
...
var author$project$Test$Generated$Main2148181965$main = A2(
	author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/pulkit/Playground/exercism/elm/difference-of-squares/tests/Tests.elm']),
		processes: 8,
		report: author$project$Test$Reporter$Reporter$ConsoleReport(author$project$Console$Text$UseColor),
		runs: elm$core$Maybe$Nothing,
		seed: 372075481171440
	},
...
_Platform_export({'Test':{'Generated':{'Main2148181965':{'init':author$project$Test$Generated$Main2148181965$main(elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-2295.sock";
