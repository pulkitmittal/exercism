...
var author$project$ScrabbleScore$scores = elm$core$Dict$fromList(
	_List_fromArray(
		[
			_Utils_Tuple2(
			_Utils_chr('A'),
...
var author$project$ScrabbleScore$getScore = function (alpha) {
	return A2(
		elm$core$Maybe$withDefault,
		0,
		A2(elm$core$Dict$get, alpha, author$project$ScrabbleScore$scores));
};
var elm$core$List$sum = function (numbers) {
	return A3(elm$core$List$foldl, elm$core$Basics$add, 0, numbers);
};
var elm$core$String$toUpper = _String_toUpper;
var author$project$ScrabbleScore$scoreWord = function (x) {
	return elm$core$List$sum(
		A2(
			elm$core$List$map,
			author$project$ScrabbleScore$getScore,
		...
		[
			...
			function (_n0) {
				return A2(
					...
					1,
					author$project$ScrabbleScore$scoreWord('a'));
			}),
			A2(
			elm_explorations$test$Test$test,
			'uppercase letter',
			...
			function (_n2) {
				return A2(
					elm_explorations$test$Expect$equal,
					4,
					author$project$ScrabbleScore$scoreWord('f'));
			}),
			A2(
			elm_explorations$test$Test$test,
			'short word',
			function (_n3) {
				return A2(
					elm_explorations$test$Expect$equal,
					2,
					author$project$ScrabbleScore$scoreWord('at'));
			}),
			A2(
			elm_explorations$test$Test$test,
			'short, valuable word',
			function (_n4) {
				return A2(
					elm_explorations$test$Expect$equal,
					12,
					author$project$ScrabbleScore$scoreWord('zoo'));
			}),
			A2(
			elm_explorations$test$Test$test,
			'medium word',
			function (_n5) {
				return A2(
					elm_explorations$test$Expect$equal,
					6,
					author$project$ScrabbleScore$scoreWord('street'));
			}),
			A2(
			elm_explorations$test$Test$test,
			...
			function (_n6) {
				return A2(
					elm_explorations$test$Expect$equal,
					22,
					author$project$ScrabbleScore$scoreWord('quirky'));
			}),
			A2(
			elm_explorations$test$Test$test,
			...
			function (_n7) {
				return A2(
					elm_explorations$test$Expect$equal,
					41,
					author$project$ScrabbleScore$scoreWord('OxyphenButazone'));
			}),
			A2(
			elm_explorations$test$Test$test,
			'english-like word',
			function (_n8) {
				return A2(
					elm_explorations$test$Expect$equal,
					8,
					author$project$ScrabbleScore$scoreWord('pinata'));
			}),
			A2(
			elm_explorations$test$Test$test,
			...
			function (_n9) {
				return A2(
					elm_explorations$test$Expect$equal,
					7,
					author$project$ScrabbleScore$scoreWord('piñata'));
			}),
			A2(
			elm_explorations$test$Test$test,
			'empty input',
			function (_n10) {
				return A2(
					elm_explorations$test$Expect$equal,
					0,
					author$project$ScrabbleScore$scoreWord(''));
			})
		]));
...
var author$project$Test$Generated$Main1296276059$main = A2(
	author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/pulkit/Playground/exercism/elm/scrabble-score/tests/Tests.elm']),
		processes: 8,
...
_Platform_export({'Test':{'Generated':{'Main1296276059':{'init':author$project$Test$Generated$Main1296276059$main(elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-8793.sock";
