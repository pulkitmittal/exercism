...
var author$project$Accumulate$funcIt = F3(
	function (func, input, output) {
		var v = elm$core$List$head(input);
		if (v.$ === 'Nothing') {
			return output;
		} else {
			var xs = v.a;
			return A3(
				author$project$Accumulate$funcIt,
				func,
...
var author$project$Accumulate$accumulate = F2(
	function (func, input) {
		return A3(author$project$Accumulate$funcIt, func, input, _List_Nil);
	});
...
var author$project$Test$Generated$Main2375230808$main = A2(
	author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/pulkit/Playground/exercism/elm/accumulate/tests/Tests.elm']),
		processes: 8,
		report: author$project$Test$Reporter$Reporter$ConsoleReport(author$project$Console$Text$UseColor),
		runs: elm$core$Maybe$Nothing,
		seed: 209825638133015
	},
...
_Platform_export({'Test':{'Generated':{'Main2375230808':{'init':author$project$Test$Generated$Main2375230808$main(elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
