...
var author$project$Bob$isNothing = function (remark) {
	return elm$core$String$isEmpty(remark);
};
...
var author$project$Bob$isYelling = function (remark) {
	return A2(elm$core$String$any, elm$core$Char$isAlpha, remark) && _Utils_eq(
...
var author$project$Bob$hey = function (remark) {
	...
	return (author$project$Bob$isYelling(trimmed) && author$project$Bob$isQuestion(trimmed)) ? 'Calm down, I know what I\'m doing!' : (author$project$Bob$isYelling(trimmed) ? 'Whoa, chill out!' : (author$project$Bob$isQuestion(trimmed) ? 'Sure.' : (author$project$Bob$isNothing(trimmed) ? 'Fine. Be that way!' : 'Whatever.')));
};
...
var author$project$Test$Generated$Main2870958899$main = A2(
	author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/pulkit/Playground/exercism/elm/bob/tests/Tests.elm']),
		processes: 8,
		report: author$project$Test$Reporter$Reporter$ConsoleReport(author$project$Console$Text$UseColor),
		runs: elm$core$Maybe$Nothing,
		seed: 129822851684738
	},
...
_Platform_export({'Test':{'Generated':{'Main2870958899':{'init':author$project$Test$Generated$Main2870958899$main(elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-4290.sock";
