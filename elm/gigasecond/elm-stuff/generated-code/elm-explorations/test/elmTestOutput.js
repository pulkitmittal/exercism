...
var author$project$Gigasecond$add = function (timestamp) {
	return elm$time$Time$millisToPosix(
		A2(elm$core$Basics$pow, 10, 12) + elm$time$Time$posixToMillis(timestamp));
};
...
var author$project$Test$Generated$Main47958269$main = A2(
	author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/pulkit/Playground/exercism/elm/gigasecond/tests/Tests.elm']),
		processes: 8,
		report: author$project$Test$Reporter$Reporter$ConsoleReport(author$project$Console$Text$UseColor),
		runs: elm$core$Maybe$Nothing,
		seed: 319882498430915
	},
...
_Platform_export({'Test':{'Generated':{'Main47958269':{'init':author$project$Test$Generated$Main47958269$main(elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-2458.sock";
