...
var author$project$TwelveDays$lyrics = _List_fromArray(
	...
	function (start, stop) {
		return elm$core$Array$toList(
			A3(
				...
				start - 1,
				stop,
				elm$core$Array$fromList(author$project$TwelveDays$lyrics)));
	});
...
var author$project$Test$Generated$Main4268341212$main = A2(
	author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/pulkit/Playground/exercism/elm/twelve-days/tests/Tests.elm']),
		processes: 8,
		report: author$project$Test$Reporter$Reporter$ConsoleReport(author$project$Console$Text$UseColor),
		runs: elm$core$Maybe$Nothing,
		seed: 304007008296182
	},
...
_Platform_export({'Test':{'Generated':{'Main4268341212':{'init':author$project$Test$Generated$Main4268341212$main(elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-5769.sock";
